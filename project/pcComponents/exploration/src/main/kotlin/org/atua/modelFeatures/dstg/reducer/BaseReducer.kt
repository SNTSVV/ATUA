...
{
    override fun reduce(guiWidget: Widget, guiState: State<*>, isOptionsMenu:Boolean, guiTreeRectangle: Rectangle, window: Window, rotation: org.atua.modelFeatures.Rotation, atuaMF: org.atua.modelFeatures.ATUAMF, tempWidgetReduceMap: HashMap<Widget,AttributePath>
    ...
    fun parentReduce(guiWidget: Widget, guiState: State<*>, isOptionsMenu:Boolean, guiTreeRectangle: Rectangle, window: Window, rotation: org.atua.modelFeatures.Rotation, atuaMF: org.atua.modelFeatures.ATUAMF, tempWidgetReduceMap: HashMap<Widget,AttributePath>,
                     tempChildWidgetAttributePaths: HashMap<Widget, AttributePath>): AttributePath?{
